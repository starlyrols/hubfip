...
const MAX_ITEMS = 20;
const OPERATOR_DEFAULT = ['observatoire', 'qos', 'revenus', 'connecteurs', 'registre', 'reporting', 'mesures', 'reclamations'];
...
function defaults() {
  return {
    ...
    directions: {
      ...
      DM: ['observatoire', 'operators', 'geo', 'registre', 'reporting', 'tiers', 'postal'],
      DFC: ['observatoire', 'revenus', 'registre', 'reporting'],
      DHQR: ['observatoire', 'qos', 'connecteurs', 'geo', 'registre', 'reporting', 'mesures', 'reclamations', 'postal'],
      DCTLF: ['observatoire', 'antifraude', 'investigation', 'geo', 'analytics', 'registre', 'reporting'],
      DJ: ['observatoire', 'antifraude', 'investigation', 'securite', 'registre', 'reporting', 'tiers', 'mesures'],
      DSIN: ['observatoire', 'connecteurs', 'geo', 'admin', 'securite', 'registre'],
      DCBA: ['observatoire', 'registre', 'reporting', 'securite'],
      DRH: ['observatoire'], DDSU: ['observatoire'], DIAI: ['observatoire'], DRRRS: ['observatoire'],
    },
