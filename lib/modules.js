...
const MODULES = [
  ...
  // Extension M15 — gestion des dossiers (standard BPM, docs/BPM-GESTION-DOSSIERS.md).
  { id: 'workflow', label: 'Gestion des dossiers (M15)', section: 'Gestion des dossiers (M15)', parent: 'monitoring', assignable: true },
