...
// `points` est exposé en LECTURE seule : le réseau est ensemencé une fois au
// chargement et ne doit pas pouvoir être altéré par un consommateur.
module.exports = { SERVICES, tick, report, points: () => points.slice() };
