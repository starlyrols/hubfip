...
const MAX_ITEMS = 20;
const OPERATOR_DEFAULT = ['observatoire', 'qos', 'revenus', 'connecteurs', 'registre', 'reporting'];
...
function defaults() {
  return {
    ...
    directions: {
      ...
      DM: ['observatoire', 'operators', 'geo', 'registre', 'reporting'],
      DFC: ['observatoire', 'revenus', 'registre', 'reporting'],
      DHQR: ['observatoire', 'qos', 'connecteurs', 'geo', 'registre', 'reporting'],
      DCTLF: ['observatoire', 'antifraude', 'investigation', 'geo', 'analytics', 'registre', 'reporting'],
      DJ: ['observatoire', 'antifraude', 'investigation', 'securite', 'registre', 'reporting'],
