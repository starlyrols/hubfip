...
function createApp(opts = {}) {
  ...
  app.post('/api/v1/probes/campaign', requireModule('mesures'), (req, res) => {
  ...
  // Services financiers postaux (SP).
  app.get('/api/v1/postal', requireModule('postal'), (_req, res) => res.json(postal.report()));
