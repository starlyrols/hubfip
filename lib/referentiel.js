...
// TVA applicable aux frais de service (loi de finances) — sert au simulateur et
// au contrôle de cohérence du champ obligatoire `tax_amount` du contrat.
const VAT_RATE = 0.18;
...
module.exports = {
  ...
  DEFAULT_FEES, CONTRIBUTION_RATE, VAT_RATE, CITIES, CELLS, AGENTS, SUBSCRIBERS,
